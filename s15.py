...
while True:
    ...
    preview_cropped_frame = preview_frame[y1:y2, x1:x2]
    ...
    preview_zoomed_frame = cv2.resize(preview_cropped_frame, (canvas_width, canvas_height), interpolation=cv2.INTER_LINEAR)
    ...
    #                 cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 255, 0), 2)
        ...
        # last_face_box = (x1, y1, x2, y2, conf)
        # face_width = box_x2_rel - box_x1_rel
        # face_height = box_y2_rel - box_y1_rel
        # deadzone_width = int(face_width * conf_parameters["dead_zone_scale"])
        # deadzone_height = int(face_height * conf_parameters["dead_zone_scale"])

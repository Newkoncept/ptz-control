...
print("✅ Video capture initialized in", round(time.time() - start, 2), "s")
...
print("✅ cap not opened set in", round(time.time() - start, 2), "s")


# Set capture resolution to 1080p
# cap.set(cv2.CAP_PROP_FRAME_WIDTH, 1920)
# print("✅ cap width set in", round(time.time() - start, 2), "s")

# cap.set(cv2.CAP_PROP_FRAME_HEIGHT, 1080)
# print("✅ cap height set in", round(time.time() - start, 2), "s")

cv2.setUseOptimized(True)
print("✅ setuseroptimized set in", round(time.time() - start, 2), "s")


print("✅ resolution set in", round(time.time() - start, 2), "s")

WINDOW_NAME = "Smart Zoom"
cv2.namedWindow(WINDOW_NAME, cv2.WINDOW_NORMAL)

print("✅ namedwindow initialized in", round(time.time() - start, 2), "s")
...
print("✅ vaariables initialized in", round(time.time() - start, 2), "s")
...
while True:
    ...
    # === Inference Control ===
    run_detection = tracking_enabled
    ...
    zoomed = cv2.resize(cropped, (desired_width, desired_height))
    preview_zoomed = cv2.resize(hud_cropped, (desired_width, desired_height))
